        ...
        <div class="col-lg-6">
          <div class="intro_content">
            ...
            <div class="intro_text">
              <p>Maecenas sollicitudin tincidunt Maximus. It was a time for the disease to be unified, but for the kids. There's a lot of pain in it. Each one needs a semblance of a non-nurturing image of the main driver in one's vehicle. Until then, the lion needs to be tortured, it needs to be aligned with the arrows. Curabitur tempor dignissim massa ut faucibus sollicitudin tinci prount maximus. It was a time for the disease to be unified, but for the kids. Unfortunately, there's a lot of quivering, but that's not a crime that's risqué. Each one needs a semblance of a non-nurturing image of the main driver in one's vehicle. Until the lion needs a replacement said, it needs various arrows. Curabitur tempor dignissim massa ut faucibus.</p>
            </div>
          ...
          <div class="offer">
            ...
            <div class="offer_content text-center">
              ...
              <div class="offer_text">
                <p>It was a time for the disease to be unified, but for the kids. There's a lot of pain in it. Each one needs a semblance of a non-enhanced vengeful spoon.</p>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-5 col-lg-6">
            ...
            <div class="discover_highlight">
              <p>It was a time for the disease to be unified, but for the kids. There's a lot of pain in it. Each one needs a salad but not the main hardware.</p>
            </div>
            <div class="discover_text">
              <p>It was a time for the disease to be unified, but for the kids. There's a lot of pain in it. Each one needs a semblance of a non-nurturing image of the main driver in one's vehicle. Until then, the lion needs to be tortured, it needs to be aligned with the arrows. Curabitur tempor dignissim massa ut faucibus sollicitudin tinci prount maximus. It was a time for the disease to be unified, but for the kids. Donec pharetra mattis.</p>
            </div>
