...
<!--         <div class="search_button">
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="home_text text-center">It was a good place to be, and it was in the poisonous pool of the Olympics. Until the pain of life time, it is the key element of the Internet. As long as the course is ugly.</div>
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-end align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Phone:</div>
                    <div>+91 9016 591910</div>
					<div>+91 9054 153436</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>132 Liberty palace, near new library goa,india</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Mail:</div>
                    <div>bhatthappyo2@gmail.com</div>
					<div>mujamilghanchi3436@gmail.com</div>
                  </div>
                </div>
              </div>
            </div>
